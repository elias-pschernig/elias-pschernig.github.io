...
def plot_column(plotter, column, a, b, num):
    ...
    for i in range(a, b):
        ...
        if i < n:
            ...
            family = f"{s.family_scientific}/{s.family_common}"
        else:
            name = ""
        ...
        if args.inat_links:
            place = args.places
            inat = f"https://www.inaturalist.org/observations?verifiable=true&taxon_id={tid}&place_id={place}"
